...
import { CustomInput, CustomTextarea } from "@/app/components";
import { AtSign, BookUser, Phone } from "lucide-react";
      ...
      <section id="contact_us" className="relative z-10 overflow-hidden bg-white py-32 dark:bg-dark lg:py-[120px]">
        <div className="container">
          ...
          data-aos-duration="2000">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12" data-aos="fade-up">
